...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  if (!onboarding) {
    throw new Response("Seller onboarding record was not found.", {
      status: 404,
    });
  }
...
const cardStyle = {
  ...
  borderRadius: "16px",
  padding: "22px",
  boxShadow: "0 3px 12px rgba(75, 22, 120, 0.06)",
};
...
export default function SellerOnboardingPage() {
  const { seller, onboarding, portalAccount } =
    ...
    <div style={pageStyle}>
      <div style={shellStyle}>
        ...
        >
          ...
          >
            Your HairGrab seller account is approved. We already carried your
            registration information into your account, so you won't need to
            enter it again.
          </p>
        ...
        >
          ...
          <ChecklistRow
            ...
            complete={onboarding.businessComplete}
            current={currentStep === "BUSINESS"}
          />

          <ChecklistRow
            title="Storefront"
            description="Add your storefront description, logo and public seller information."
            complete={onboarding.storefrontComplete}
          ...
          <ChecklistRow
            ...
            complete={onboarding.fulfillmentComplete}
          ...
          <ChecklistRow
            ...
            complete={onboarding.returnsComplete}
            current={currentStep === "RETURNS"}
          />

          <ChecklistRow
            title="Payouts"
            description="Connect your payout account so HairGrab can send your seller earnings."
            complete={onboarding.payoutsComplete}
            current={currentStep === "PAYOUTS"}
          />

          <ChecklistRow
            title="Seller agreements"
            description="Review and accept HairGrab marketplace seller terms."
            complete={onboarding.agreementsComplete}
            current={currentStep === "AGREEMENTS"}
          />

          <ChecklistRow
            title="Products"
            description="Add products manually or import your hair catalog when you're ready."
            complete={onboarding.productsComplete}
            current={currentStep === "PRODUCTS"}
          />
        </div>
        ...
        <div style={cardStyle}>
          ...
          >
            HairGrab carried this information forward automatically.
          </p>
          ...
          >
            ...
            <div>
              ...
              <div style={valueStyle}>
                {displayValue(
                  [seller.contactFirstName, seller.contactLastName]
                    .filter(Boolean)
                    .join(" "),
                )}
              </div>
            ...
            <div>
              ...
              <div style={valueStyle}>
                {displayValue(seller.postalCode)}
              </div>
            </div>
            ...
            <div>
              ...
              <div style={valueStyle}>
                {displayValue(seller.tiktok)}
              </div>
            </div>

            <div>
              <div style={labelStyle}>Ships Nationwide</div>
              <div style={valueStyle}>
                {yesNo(seller.sellsNationwide)}
              </div>
            </div>

            <div>
              <div style={labelStyle}>Local Pickup</div>
              <div style={valueStyle}>
                {yesNo(seller.offersLocalPickup)}
              </div>
            </div>

            <div>
              <div style={labelStyle}>Local Delivery</div>
              <div style={valueStyle}>
                {yesNo(seller.offersLocalDelivery)}
              </div>
            </div>
          </div>
