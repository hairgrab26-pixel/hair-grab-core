...
const products: DiscoveryProduct[] = [
  { id: "1", title: "24 inch Body Wave Wig", handle: "one", category: "Wigs", subtype: "Glueless", texture: "Body Wave", lengths: ["24"], colors: ["Natural"], priceCents: 28000, compareAtPriceCents: null, shipsWithin: "24 hours", fulfillment: ["Nationwide Shipping"], seller: "A", sellerCode: "A", city: "Atlanta", state: "GA", available: true, createdAt: "2026-01-02", imageUrl: null },
  { id: "2", title: "Burgundy Body Wave Bundles", handle: "two", category: "Bundles", subtype: "", texture: "Body Wave", lengths: ["20"], colors: ["Burgundy"], priceCents: 19000, compareAtPriceCents: null, shipsWithin: "2 days", fulfillment: ["Local Pickup"], seller: "B", sellerCode: "B", city: "Miami", state: "FL", available: true, createdAt: "2026-01-01", imageUrl: null },
];
