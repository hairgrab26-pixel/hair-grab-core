...
export const ADMIN_PRODUCT_METAFIELDS: AdminMetafieldSpec[] = [
  ...
  { formKey: "density", names: ["Density"], key: "density", tagLabels: ["Density"] },
  ...
  { formKey: "shipsWithin", names: ["Ships Within"], key: "ships_within", tagLabels: ["Ships Within"] },
  { formKey: "capType", names: ["Cap Type"], key: "cap_type", tagLabels: ["Cap Type"] },
